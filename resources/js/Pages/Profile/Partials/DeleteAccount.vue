<template>
    <div id="delete" class="card my-4 slide-up-on-hover">
        ...
        <div class="card-body d-sm-flex pt-0">
            <argon-button @click="toggleUserStatus()" :color="$page.props.auth.user.status === 'active' ? 'secondary' : 'primary'"
                variant="outline" class="mb-0 ms-auto" type="button" name="button">
                <span v-if="$page.props.auth.user.status === 'active'">Deactivate</span>
                <span v-else>Activate</span>
            </argon-button>
            <argon-button color="danger" variant="gradient" class="mb-0 ms-2" type="button" name="button"
            ...
            <div class="modal-content py-2 px-3">
                ...
                <div class="modal-body" style="color: black !important;">
                    ...
                    <div class="input-group mb-3 border">
                        <input v-model="form.password" type="password" class="form-control ps-2" placeholder="Password"
                ...
                <div class="d-flex justify-content-end">
                    <button type="button" class="btn btn-danger mx-1" @click="deleteUser" data-dismiss="modal">
                        Delete Account
                    </button>
...
function toggleUserStatus() {
    router.put(route('user.toggleStatus', { id: page.props.auth.user.id }));
};
</script>
