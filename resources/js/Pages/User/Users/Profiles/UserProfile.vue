                ...
                <div class="card p-4 border-radius-xl bg-white">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-6 mt-3 mt-sm-0">
                            <label>Email</label>
                            <argon-input id="email" type="email" placeholder="eg. argon@dashboard.com" />
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-12 col-sm-6">
                        ...
                        <div class="col-12 col-sm-6 mt-sm-0">
                            ...
                            <argon-input id="referralCode" type="text" placeholder="eg. A4564G" />
                        </div>
                    </div>
                    <div class="d-flex mt-2 justify-content-end">
                        <p class="my-auto mx-3" style="cursor: pointer" @click="onChangePasswordClicked">
                            Change Password
                        </p>
                        <argon-button type="button" color="success" class="border w-30"
                            @click="onEditProfileButtonClicked">Edit Profile</argon-button>
                    </div>
                </div>
            </div>
        </div>
...
const onChangePasswordClicked = () => {
    router.visit(route('user.password.edit'));
};

const onEditProfileButtonClicked = () => {
    router.visit(route('user.edit'));
};
</script>
